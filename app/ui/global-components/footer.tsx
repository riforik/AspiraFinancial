        ...
        <div className="w-full md:w-1/2 lg:w-1/2 mt-8 md:mt-0 border-2 border-gray-200 bg-white rounded-lg p-4 flex flex-col justify-center leading-normal shadow-md">
            ...
            <div className="flex gap-8 mt-2">
              ...
              <Link
                key="register"
                href="/register"
                className="w-1/3 rounded-md bg-aspiraPrimary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Stay Updated
                </Link>
            </div>
